...
namespace Main.Model
{
    ...
    public class PivotModel : MonoBehaviour
    {
        ...
        [SerializeField] string[] tags = { ConstTagNames.TAG_ATTACK_TRIGGER };
        ...
        [SerializeField] Vector3[] vectorDirectionModes = { new Vector3(0, 0, 0f), new Vector3(0, 0, -90f), new Vector3(0, 0, 180f), new Vector3(0, 0, 90f) };
